...
def create_handoff_metadata(mdata, params_rna, params_atac):
    ...
    handoff_data = {
        "outputs": {
            ...
            "rna_connectivity": "conn_rna",     # (n_cells, n_cells) CSR matrix, row-normalized
            "atac_connectivity": "conn_atac"    # (n_cells, n_cells) CSR matrix, row-normalized
        },
        "parameters": {
            "n_components": 50,
            "k": 15,
...
def run_person2_pipeline(input_file, output_file=None, n_components=50, k=15):
    """
